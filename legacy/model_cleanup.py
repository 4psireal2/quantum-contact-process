...
#         model.add_onsite_term(-1j / 2. * gamma, i, 'number')  # TODO: why is there an imaginary term here?
#         # model.add_onsite_term(-1/2. *gamma, i, 'number') # TODO: shouldnt the line above be this?
